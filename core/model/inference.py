...
class FusionAgent:
    def __init__(self, model="llama-3.3-70b-versatile"):
        ...
        self.system_prompt = """
        You are the 'Distress Monitor' for a VR Therapy Platform. 
        ...
        Your task:
        Determine the user's current 'Distress Level' (0-100) and provide a recommendation for the VR environment change (e.g., 'Lower volume', 'Switch to relaxing room', 'No change').
